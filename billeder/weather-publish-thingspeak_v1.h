...
TCPClient client;
unsigned int myChannelNumber = 161372;
const char * myWriteAPIKey = "CD5NKO8YDRGUUQRC";
...
void loop()
{
      ...
      if(millis() - lastPublish > 1000*60) //Publishes every 5000 milliseconds, or 5 seconds
      {
